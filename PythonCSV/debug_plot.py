...
from experiment.loop import process_folder_namings, show_plot_for_dgilib_data
from experiment.helpers import get_dgilib_data_from_csv
...
show_plot_for_dgilib_data(data)
