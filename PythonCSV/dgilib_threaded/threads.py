...
# Main #
########
def measure(duration, iterations, dgilib_config_dict, input_acc_file, input_gyro_file, output_file, waitForPlot=False):
    ...
    data, preprocessed_data = dgilib_logger(duration, dgilib_config_dict, logger_stop_queue, sender_start_queue, waitForPlot)
